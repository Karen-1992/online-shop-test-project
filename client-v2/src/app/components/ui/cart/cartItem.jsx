...
const CartItem = ({
    ...
    const [selectedAttributes, setSelectedAttributes] = useState(cartItem.selectedAttributes);
    ...
    useEffect(() => {
        updateAttributes(cartItem, cartItemIndex, productId, selectedAttributes )
        updateQuantity();
    }, [productId]);
